...
function generate() {
            ...
            doc.text( 240, 120, "Mass Payments");
            doc.setFontSize(10);
            ...
            if (selectedRows.length > 0) {
                selectedRows.forEach(function(row) {
                    ...
                    var rowData = {
                        ...
                        intention: columns[5].textContent,
                        amt: columns[6].textContent,
                        status: columns[7].textContent
                    };
                    data.push(rowData);
                });
            } else {
            ...
            var startY = 150;
            doc.autoTable({
                head: [['No','Name', 'Payment Date',  'Mobile', 'Intention','Amount','Status']],
                body: data.map(item => [item.no,item.name, item.date, item.mobile, item.intention,item.amt,item.status]),
                startY: startY,
                styles: {
