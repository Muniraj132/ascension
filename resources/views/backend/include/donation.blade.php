              ...
              <table id="simple_table" class="table table-bordered table-striped">
                    <thead>
                        <div class="d-flex justify-content-end mb-4">
                          <h4 style="margin-right: 640px;">Today Contribution</h4><input type="button" id="export-pdf-button" class="btn btn-primary" onclick="generate()" value="Export To PDF" disabled>
                       </div> 
                        <tr>
                            ...
                            <th class="bg-info">Donation purpose</th>
                    ...
                    @foreach ($donate as $key=> $value)
                           <tr>    
                              ...
                              <td class="text-left">{{$value->udf4}}</td>
...
function generate() {
          ...
          doc.text( 240, 120, "Today Contribution");
          doc.setFontSize(10);
          ...
          if (selectedRows.length > 0) {
              selectedRows.forEach(function(row) {
                  ...
                  var rowData = {
                      ...
                      comments: columns[3].textContent,
                      place: columns[4].textContent,
                      mobile: columns[5].textContent,
                      amt: columns[6].textContent,
          ...
          var startY = 150;
          doc.autoTable({
              head: [['Name', 'Comments', 'Place','Mobile','Amount']],
              body: data.map(item => [item.name,  item.comments, item.place, item.mobile,item.amt]),
              startY: startY,
              styles: {
          ...
          doc.save('TodayContribution.pdf');
      }
